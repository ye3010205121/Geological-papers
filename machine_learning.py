...
# python test.py --dataset "dataset" --neighbors "2"
...
model.fit(trainRI, trainRL)
acc = model.score(testRI, testRL)
print("[INFO] XGB raw pixel accuracy: {:.2f}%".format(acc * 100))
...
model.fit(trainFeat, trainLabels)
acc = model.score(testFeat, testLabels)
print("[INFO] XGB histogram accuracy: {:.2f}%".format(acc * 100))
'''
SVC
print("\n")
print("[INFO] evaluating raw pixel accuracy...")
...
model.fit(trainRI, trainRL)
acc = model.score(testRI, testRL)
print("[INFO] GBDT raw pixel accuracy: {:.2f}%".format(acc * 100))
...
model.fit(trainFeat, trainLabels)
acc = model.score(testFeat, testLabels)
print("[INFO] GBDT histogram accuracy: {:.2f}%".format(acc * 100))
'''
